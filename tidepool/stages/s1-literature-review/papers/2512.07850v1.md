...
Authors: Alejandro Cuadron 1 Pengfei Yu 1 Yang Liu 1 Arpit Gupta 1 1 Amazon AGI Foundations

## Contents
- [1 Introduction](https://arxiv.org/html/2512.07850v1#S1)
- [2 Related Work](https://arxiv.org/html/2512.07850v1#S2)
  - [Agency in AI systems.](https://arxiv.org/html/2512.07850v1#S2.SS0.SSS0.Px1)
  - [Multi-agent systems.](https://arxiv.org/html/2512.07850v1#S2.SS0.SSS0.Px2)
  - [User simulators for enhancing AI systems.](https://arxiv.org/html/2512.07850v1#S2.SS0.SSS0.Px3)
  - [Benchmarks for agent evaluation.](https://arxiv.org/html/2512.07850v1#S2.SS0.SSS0.Px4)
- [3 Problem Formulation](https://arxiv.org/html/2512.07850v1#S3)
  - [Background.](https://arxiv.org/html/2512.07850v1#S3.SS0.SSS0.Px1)
  - [Decisive deviation (comparative).](https://arxiv.org/html/2512.07850v1#S3.SS0.SSS0.Px2)
  - [Mutating vs. non-mutating insertions.](https://arxiv.org/html/2512.07850v1#S3.SS0.SSS0.Px3)
  - [From local deviations to a dataset-level test.](https://arxiv.org/html/2512.07850v1#S3.SS0.SSS0.Px4)
- [4 SABER: Safeguarding Against Mutating Actions](https://arxiv.org/html/2512.07850v1#S4)
  - [4.1 Safeguards for Mutating Actions](https://arxiv.org/html/2512.07850v1#S4.SS1)
  - [4.2 SABER System Implementation](https://arxiv.org/html/2512.07850v1#S4.SS2)
- [5 Tau-Bench Verified](https://arxiv.org/html/2512.07850v1#S5)
  - [5.1 Existing Issues in $τ \tau$-Bench](https://arxiv.org/html/2512.07850v1#S5.SS1)
  - [5.2 Under-specified user instructions.](https://arxiv.org/html/2512.07850v1#S5.SS2)
  - [5.3 $τ \tau$-Bench Verified.](https://arxiv.org/html/2512.07850v1#S5.SS3)
- [6 Experiments](https://arxiv.org/html/2512.07850v1#S6)
  - [6.1 SABER improves performance in agentic tasks](https://arxiv.org/html/2512.07850v1#S6.SS1)
- [7 Conclusion](https://arxiv.org/html/2512.07850v1#S7)
- [8 Limitations](https://arxiv.org/html/2512.07850v1#S8)
- [A Broader Impacts](https://arxiv.org/html/2512.07850v1#A1)
- [B Reproducibility Statement.](https://arxiv.org/html/2512.07850v1#A2)
- [C Appendix: Corrections to $τ \tau$-Bench–Airline](https://arxiv.org/html/2512.07850v1#A3)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx1.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx1.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx2.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx2.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx3.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx3.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx4.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx4.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx5.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx5.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx6.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx6.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx7.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx7.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx8.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx8.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx9.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx9.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx10.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx10.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx11.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx11.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx12.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx12.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx13.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx13.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx14.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx14.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx15.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx15.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx16.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx16.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx17.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx17.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx18.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx18.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx19.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx19.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx20.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx20.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx21.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx21.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx22.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx22.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx23.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx23.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A3.SSx24.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A3.SSx24.SSS0.Px2)
- [D Appendix: Corrections to $τ \tau$-Bench—Retail (Action-Level Annotations)](https://arxiv.org/html/2512.07850v1#A4)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx1.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx1.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx2.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx2.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx3.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx3.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx4.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx4.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx5.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx5.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx6.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx6.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx7.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx7.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx8.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx8.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx9.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx9.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx10.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx10.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx11.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx11.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx12.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx12.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx13.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx13.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx14.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx14.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx15.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx15.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx16.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx16.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx17.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx17.SSS0.Px2)
  - [Why it is wrong.](https://arxiv.org/html/2512.07850v1#A4.SSx18.SSS0.Px1)
  - [Fix explanation.](https://arxiv.org/html/2512.07850v1#A4.SSx18.SSS0.Px2)
...
Real-world, long-horizon tasks—whether in enterprise operations, software engineering, scientific analysis, or multi-step information retrieval—demand language agents that can plan, invoke tools, and maintain coordinated behavior across many turns (chen2025surveyllmbasedmultiagentsystem; kanoulas2025agentcentricinformationaccess; yang2024sweagentagentcomputerinterfacesenable). Despite impressive single-step capabilities, today’s leading agents are brittle in extended interactions: they misinterpret constraints, rely on stale context, and issue tool calls that derail progress (jimenez2024swebench; yao2024taubenchbenchmarktoolagentuserinteraction; kwan2024mtevalmultiturncapabilitiesevaluation; wang2024mint). Current frameworks typically treat all decision steps uniformly—end-to-end prompting, generic scoring, and whole-trajectory reruns all assume the same level of scrutiny across actions (park2023generativeagentsinteractivesimulacra; yuan2025agentrtraininglanguagemodel; chen2024agentflandesigningdatamethods; zhou2025mem1learningsynergizememory; chhikara2025mem0buildingproductionreadyai; han2025joyagentsr1jointevolutiondynamics). Recent analyses catalog broad behavioral failures (zhang2025agentcausestaskfailures; cemri2025multiagentllmsystemsfail), but rarely pinpoint the specific decision steps where success flips to failure. Our study begins with a simple question: *Do all actions contribute equally to task failure?*

Figure: Figure 1: Illustration of Targeted Reflection and Mutation-Gated User Verification
Refer to caption: x1.png

We answer this by analyzing execution traces of strong open- and closed-weight models on $\tau$-Bench (Section [3](https://arxiv.org/html/2512.07850v1#S3)). Partitioning the action space into *mutating* (state-changing such as cancelling a booking, issuing a refund, deleting a file) and *non-mutating* (information-gathering) steps, we show by fitting a regression model that deviations in mutating actions are the decisive predictors of failure, with each additional deviation in the number of mutating actions reducing the odds of success by $55\%\sim 92\%$ on the Airline subset and $87\%\sim 96\%$ on the Retail subset (all $p<0.001$), respectively, for three different models including Qwen3-Thinking-235B, GPT-5 and Claude-4-Sonnet. Meanwhile, deviations in non-mutating steps have little effect: always below 10% success ratio reduction per non-mutating deviation on both Airline and Retail subsets, with non-significant $p$-values on some cases (details in Table [1](https://arxiv.org/html/2512.07850v1#S3.T1)). In short, failures cluster at a small slice of mutating steps, revealing a disproportionately risky subset of the decision space.

However, efficiency at the mutating gate alone is not enough, because errors grow more frequent as context length increases. Agents progressively lose fidelity to their intended role and policies due to “lost-in-the-middle” effects and the over-trust of stale tokens (liu2023lostmiddlelanguagemodels; laban2025llmslostmultiturnconversation). Even trajectories that begin correctly can drift, leading to misaligned or outdated tool calls at later mutating steps (kwan2024mtevalmultiturncapabilitiesevaluation; wang2024mint; cemri2025multiagentllmsystemsfail). To sustain reliability in long-horizon settings, we propose two additional mechanisms: lightweight reminders that sharpen constraints before risky steps, and context cleaning that keeps verification-critical history salient. Together, these measures aim to preserve alignment while keeping intervention selective rather than overwhelming.

Yet drawing such conclusions requires trust in the benchmark itself. We found that $\tau$-Bench, though widely adopted, embeds inconsistencies and underspecified instructions that cap attainable performance and blur differences between models. For example, Airline tasks contain contradictory booking policies, and Retail tasks often omit disambiguation (e.g., “pay with the credit card” despite multiple cards on file). To support rigorous evaluation, we re-audit both domains, correcting annotation errors and clarifying policies. We release the result as $\tau$-Bench Verified, a cleaned version that preserves task coverage while removing systemic flaws. On this stronger foundation, differences between strong models re-emerge and the benefits of safeguards become clearer, as shown by the consistent gains in Table [2](https://arxiv.org/html/2512.07850v1#S6.T2).

Building on this foundation, we propose SABER, a model-agnostic, gradient-free safeguard that combines three mechanisms: *Mutation-Gated User Verification* to place decisive steps under direct scrutiny, *Targeted Reflection* to counter “lost-in-the-middle” drift, and *Block-based Context Cleaning* to prevent stale confirmations from crowding and to keep only verification-critical and goal-salient history. We illustrate *Mutation-Gated User Verification* and *Targeted Reflection* in Figure [1](https://arxiv.org/html/2512.07850v1#S1.F1), while we detail *Block-based Context Cleaning* in Section [4](https://arxiv.org/html/2512.07850v1#S4).
...
While classical AI defined agents broadly as entities that perceive and act on their environment (russell1995ai), recent work views agency as a spectrum of capabilities (zhang2024agenticinformationretrieval; kapoor2024aiagentsmatter), emphasizing autonomous goal pursuit, natural language interaction, and structured tool use (openai_function_calling_guide). This perspective has driven the development of numerous benchmarks for evaluating LLM capabilities in real-world scenarios (jimenez2024swebench; yao2024taubenchbenchmarktoolagentuserinteraction; wang2025hammerbenchfinegrainedfunctioncallingevaluation; patil2025bfcl), as well as systems that combine prompt engineering and context engineering techniques to improve agent reliability (aws_q_developer_agent; liu2024marscodeagentainativeautomated; kiro; mei2025surveycontextengineeringlarge; wang2025openhandsopenplatformai; yang2024sweagentagentcomputerinterfacesenable; wang2024executablecodeactionselicit). In contrast to prior work that focuses on building new systems to enhance performance, we analyze execution trajectories of existing state-of-the-art models to ask a fundamental question: Do all actions contribute equally to task failure? Our analysis shows that small flaws in *mutable actions* (Section [3](https://arxiv.org/html/2512.07850v1#S3)) disproportionately drive failures. Leveraging this insight, we develop SABER, the first system that combines enhanced reflection and selective human-agent collaboration to intervene only when supervision is truly necessary.

#### Multi-agent systems.

Another line of research explores using LLMs as central controllers for agents that interact with external environments beyond text-only domains (deng2023mind2webgeneralistagentweb; xie2024osworldbenchmarkingmultimodalagents). Recent work investigates multi-agent systems where multiple specialized agents interact concurrently (hong2024metagptmetaprogrammingmultiagent; li2023camelcommunicativeagentsmind), enabling collaboration for complex tasks. Although promising, such systems are often costly, prone to compounding errors, and have not demonstrated consistent gains on standard benchmarks (zhang2025agentcausestaskfailures; cemri2025multiagentllmsystemsfail). By contrast, our approach is gradient-free and single-agent, focusing on reducing critical mistakes. Specifically, SABER integrates an enhanced reflection mechanism and explicitly identifies irreversible actions that humans can approve before their execution.

#### User simulators for enhancing AI systems.

A growing body of work explores LLMs as simulators of human characters, ranging from non-player characters in games to agents embedded in human-like societies or collaborative task settings (kim-etal-2022-plm; park2023generativeagentsinteractivesimulacra; wu2023autogenenablingnextgenllm; chen2024chatshopinteractiveinformationseeking; zhang2024usimagentlargelanguagemodels; yao2024taubenchbenchmarktoolagentuserinteraction; barres2025tau2benchevaluatingconversationalagents). These efforts demonstrate that LLMs can emulate realistic human interaction patterns, but they have primarily been used for showcasing simulation rather than improving agent reliability. In our work, user simulators play a different role: they provide a scalable way to approximate the human confirmation step required by SABER. Instead of relying on human evaluators, benchmarks such as $\tau$-Bench offer simulated users that allow us to evaluate how SABER integrates human-in-the-loop feedback. This enables us to systematically test how selective confirmation of irreversible actions reduces decisive errors, while preserving efficiency in real-world scenarios.

#### Benchmarks for agent evaluation.

A variety of benchmarks have been proposed to evaluate language agents, yet important limitations remain. Stable ToolBench (qin2023toolllmfacilitatinglargelanguage) mitigates instability from external APIs through a virtual server, but relies on large models for evaluation, leading to high costs and limited scalability. BFCL (patil2025bfcl) and HammerBench (wang2025hammerbenchfinegrainedfunctioncallingevaluation) extend evaluation to multi-turn dialogues, but their trajectories are constructed from pre-defined content and fail to capture under-specified or evolving real-world user goals. $\tau$-Bench (yao2024taubenchbenchmarktoolagentuserinteraction) and $\tau^{2}$-Bench (barres2025tau2benchevaluatingconversationalagents) moves closer to realistic evaluation by embedding agents in domain-specific environments with simulated users. However, as we show in Section [5](https://arxiv.org/html/2512.07850v1#S5), annotation errors and under-specified instructions cap achievable performance, weakening its diagnostic reliability. We address this gap by releasing $\tau$-Bench Verified, a fully revised version of the Airline and Retail domains that corrects dataset inconsistencies and resolves ambiguities. This benchmark provides a more faithful and trustworthy measure of agent capabilities, enabling robust evaluation of SABER and future systems.

## 3 Problem Formulation

We introduce a formal framework to analyze decisive errors in LLM-powered agentic systems, distinguishing between environment-mutating and non-mutating actions within a standard turn-based protocol hong2024metagptmetaprogrammingmultiagent; li2023camelcommunicativeagentsmind; wu2023autogenenablingnextgenllm; zhang2025agentcausestaskfailures.
...
To connect Eq. [3](https://arxiv.org/html/2512.07850v1#S3.Ex3) and Eq. [3](https://arxiv.org/html/2512.07850v1#S3.Ex5) to corpus-level evidence, we audit trajectories via deviations from the reference plan. Let
...
Under Eq. equation [3](https://arxiv.org/html/2512.07850v1#S3.Ex5), success should decrease primarily with $d_{\mathrm{mut}}$ after controlling for $d_{\mathrm{non}}$.
...
A logistic regression shows that *mutating deviations* are the primary driver of failure, while *non-mutating deviations* matter far less (Table [1](https://arxiv.org/html/2512.07850v1#S3.T1)). An odds ratio (OR) below $1$ means each extra mismatch reduces success; for instance, in $\tau$-Bench Airline with Claude 4, a mutating mismatch cuts the odds of success by $96\%$ (OR $=0.04$), compared to only $19\%$ for a non-mutating mismatch (OR $=0.81$). Across models, mutating deviations consistently yield large, significant penalties, confirming our hypothesis (Eq. [3](https://arxiv.org/html/2512.07850v1#S3.Ex5)) that failures stem mainly from errors in mutating steps. Our objective is therefore to reduce decisive deviations, $\Pr[\Delta_{t}^{+}=1]$, by detecting when actions lie in $A^{\mathrm{mut}}$ and checking them against task constraints (system rules, tool schemas, and user requirements; Fig. [1](https://arxiv.org/html/2512.07850v1#S1.F1) (a). Safeguards applied only at these high-risk points minimize overhead while directly targeting the main source of failure. The next section introduces SABER, which operationalizes this strategy.

## 4 SABER : Safeguarding Against Mutating Actions

As shown by the unguarded failure in Fig. [1](https://arxiv.org/html/2512.07850v1#S1.F1)(a) and the dataset trends in Table [1](https://arxiv.org/html/2512.07850v1#S3.T1), decisive deviations cluster at *mutating* steps. These actions account for only 14–18% of total steps (e.g., Qwen3–Airline: 15.5%, Qwen3–Retail: 18.3%) yet dominate failure risk: a single mutating deviation reduces success odds drastically, whereas non-mutating deviations are nearly harmless (Table [1](https://arxiv.org/html/2512.07850v1#S3.T1)). To safeguard against this failure mode without overwhelming the user, we introduce SABER, a lightweight, model-agnostic context management system that plugs into existing agent loops without retraining.

### 4.1 Safeguards for Mutating Actions

Mutation-gated human verification.
SABER requires explicit user confirmation *only before executing mutating actions*, capping interruptions to roughly one in six turns. Non-mutating actions proceed autonomously. This focused scrutiny concentrates scarce user attention on the steps most likely to flip success into failure, reducing decisive errors while keeping verification burden low; cf. Fig. [1](https://arxiv.org/html/2512.07850v1#S1.F1) (c). In practice, this gating also prevents prompt-locking or stalling attacks, since the next post-feedback action is executed directly.

Targeted reflection.
In long trajectories, mutating actions $a_{t}\in A^{\mathrm{mut}}$ often produce tool calls that are syntactically valid but semantically inconsistent with system constraints, due to “lost in the middle” effects (liu2023lostmiddlelanguagemodels; laban2025llmslostmultiturnconversation). To counteract this, SABER injects a concise, high-salience summary of key instructions *at the point of mutation*. This reduces miscalibrated tool calls and improves alignment (illustrated in Fig. [1](https://arxiv.org/html/2512.07850v1#S1.F1) (b)). When reasoning traces are unsupported, the same summary is appended in a ReAct-style format to preserve guidance.

Block-based context filtering.
Verification turns can inflate dialogue history and cause *context poisoning* (breunig2025how), as shown by the growth of confirmation turns in Fig. [1](https://arxiv.org/html/2512.07850v1#S1.F1) (c). SABER therefore partitions trajectories into blocks, summarizes them, and retrieves only the most relevant blocks for the current user query. This keeps the effective context compact and pertinent, mitigating poisoning while preserving the benefits of verification. The retrieval budget $N$ is user-configurable to trade off recall and context-window pressure.
...
$\tau$-Bench (yao2024taubenchbenchmarktoolagentuserinteraction) is a recently introduced benchmark for evaluating LLM-based agents in realistic interactive environments. It provides domain-specific scenarios (e.g., airline booking, retail shopping) where an agent must complete tasks through multi-turn tool calls while interacting with a simulated user.
...
### 5.1 Existing Issues in $\tau$ -Bench
...
This is concerning given the widespread use of $\tau$-Bench to evaluate agentic capabilities of state-of-the-art models (yang2025qwen3technicalreport; openai2025gpt5; anthropic2025claude4; moonshot2025kimi-k2; hui2024qwen2).
Moreover, these problems persist even in the recently released $\tau^{2}$-Bench as these domains haven’t been updated (barres2025tau2benchevaluatingconversationalagents). We showcase two representative examples from each domain in Figure [3](https://arxiv.org/html/2512.07850v1#S5.F3), a complete set of the ground truth problems can be found in the Appendix [C](https://arxiv.org/html/2512.07850v1#A3).
...
This section is organized as follows. In Section [6.1](https://arxiv.org/html/2512.07850v1#S6.SS1), we demonstrate how SABER can enhance the performance of existing models on agentic tasks, such as those in the SWE-bench Verified, Tau-Bench Airline or Tau-Bench Retail benchmark. In Section [5](https://arxiv.org/html/2512.07850v1#S5), we conduct a detailed analysis of Tau-Bench Airline and Retail test dataset correctness and propose Tau-Bench Verified.

### 6.1 SABER improves performance in agentic tasks

We observe that every trajectory across benchmarks requires for success one or more mutating actions that can trigger a decisive error (as shown in Eq [3](https://arxiv.org/html/2512.07850v1#S3.Ex3)).
...
Retail; see Section [5](https://arxiv.org/html/2512.07850v1#S5)); additionally, due to the inherent cost of evaluating closed-source models we only evaluate Qwen3-235B-A22B-Thinking-2507 on SWE-Bench
...
standard native tool-calling setup, following prior reports for $\tau$-Bench (yao2024taubenchbenchmarktoolagentuserinteraction; anthropic2025claude4; yang2025qwen3technicalreport; openai2025gpt5).
For SWE-Bench Verified, we use OpenHands as the tool-calling framework (wang2025openhandsopenplatformai; jimenez2024swebench).
...
deviation reduces odds by only 7–15% (Table [1](https://arxiv.org/html/2512.07850v1#S3.T1)). SABER therefore
...
The choice of auxiliary model significantly affects outcomes. Using Qwen3-Thinking as the auxiliary yields only a +10 pp gain on $\tau$-Bench-Verified Airline, while pairing the reasoning-focused Qwen3-Thinking main with the instruction-tuned Qwen3-Instruct auxiliary produces much larger improvements (Table [2](https://arxiv.org/html/2512.07850v1#S6.T2)). Systematically exploring which models best complement each other is an open direction that we leave for future work.

**Table 3: Ablation study of SABER on Qwen3-Thinking-235B for $\tau$-Bench Verified Airline and Retail. Columns activate different safeguards: *Reflection*, *Mutation-gated user verification*, and their combination in *Full SABER*. In all settings, *Block-based context cleaning* is applied with the number of blocks capped at 16 (see Section [4.2](https://arxiv.org/html/2512.07850v1#S4.SS2)).**
...
The improvements support our formal analysis: decisive deviations are driven primarily by mutating actions (Eq. [3](https://arxiv.org/html/2512.07850v1#S3.Ex5)). By gating these actions through simulated user verification and reducing invalid insertions via reflection, SABER lowers the probability that a deviation at step $t$ flips a successful trajectory $\tau^{\star}$ into a failing one $\tau^{\prime}$ (Eq. [3](https://arxiv.org/html/2512.07850v1#S3.Ex3)), thereby improving overall task success.
...
We release an anonymous repository with code, data, and instructions to fully reproduce our results: [https://anonymous.4open.science/r/SABER-1E54/](https://anonymous.4open.science/r/SABER-1E54/). The repository contains (i) the SABER implementation and configuration used in all experiments (Section [4](https://arxiv.org/html/2512.07850v1#S4)); (ii) the corrected $\tau$-Bench Verified datasets (Airline/Retail), along with scripts and diffs documenting each fix (Section [5](https://arxiv.org/html/2512.07850v1#S5), Appendix A); (iii) experiment drivers, prompts, and evaluation pipelines for all models and settings reported (Section [6.1](https://arxiv.org/html/2512.07850v1#S6.SS1)); (iv) scripts to regenerate figures and tables, including the logistic-regression analyses in Table [1](https://arxiv.org/html/2512.07850v1#S3.T1).

## Appendix C Appendix: Corrections to $\tau$ -Bench–Airline
...
## Appendix D Appendix: Corrections to $\tau$ -Bench—Retail (Action-Level Annotations)
