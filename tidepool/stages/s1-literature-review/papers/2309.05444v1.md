...
|     | Cohere         | for AI  |             |                  | Cohere     | for AI    |     | Cohere           | for AI    |
|     | ted@cohere.com |         |             | ahmet@cohere.com |            |           |     | arash@cohere.com |           |
3202 peS 11  ]LC.sc[  1v44450.9032:viXra
|     | Beyza            | Ermiş |     | Acyr            | Locatelli |     |                       | Sara   | Hooker |
| --- | ---------------- | ----- | --- | --------------- | --------- | --- | --------------------- | ------ | ------ |
|     | Cohere For       | AI    |     |                 | Cohere    |     |                       | Cohere | for AI |
|     | beyza@cohere.com |       |     | acyr@cohere.com |           |     | sarahooker@cohere.com |        |        |
Abstract
TheMixtureofExperts(MoE)isawidelyknownneuralarchitecturewhereanensembleofspecialized
sub-modelsoptimizesoverallperformancewithaconstantcomputationalcost. However, conventional
...
| Released | as a preprint | on September |     | 12, 2023 | 1   |     |     |     |     |
| -------- | ------------- | ------------ | --- | -------- | --- | --- | --- | --- | --- |
...
Inthiswork, weposethequestioncan we leverage MoEs for instruction fine-tuning? Oneofthemain
...
Inthiswork, weproposeanewframeworkthatleveragesthebenefitsofMoEinaseverelyconstrained
...
(IA)3
provements over the standard at 3B and 11B model sizes respectively. This superiority
...
fine-tuned on T and then evaluated in a zero-shot manner on each unseen task from T . The
train eval
...
| --- | -------- | --- | --------- | --- | ------- | --- | --- | --- |
2.1 Parameter-efficient Fine-tuning with (IA)3 and LORA Adapters
...
(IA)3
To show how our method scales with different PEFT techniques, we experiment with both
...
| ----- | ------- | --------- | --- | --------- | ------ | ------ | ---- | --- |
| (IA)3 |         |           |     |           |        | Rd     | Rdv, | Rd  |
introduces three new vectors, lk ∈ k, lv ∈ lff ∈ ff which re-scale key and value
activations in self-attention, and intermediate activations in position-wise feed-forward layers:
|     |     |     |     |     | (cid:18) Q(lk | ⊙KT) (cid:19) |     |     |
| --- | --- | --- | --- | --- | ------------- | ------------- | --- | --- |
((IA)3)
|     |     |     |     | softmax |     | √ (lv⊙V); | (lff⊙γ | (W x))W |
| --- | --- | --- | --- | ------- | --- | --------- | ------ | ------- |
|     |     |     |     |         |     | dk        |        | 1 2     |
where Q, K, V are query, key, and value projection matrices for self-attention, and W 1 , W 2 are
frozen weights of the feed-forward layers in the pretrained model. Since (IA)3 only updates lk, lv, lff
3

|     |     |     |     | 1 class      | MOV_Layer(nn.module): |           |         |     |
| --- | --- | --- | --- | ------------ | --------------------- | --------- | ------- | --- |
...
| --- | --- | --- | --- | ----- | ------------------- | --- | --- | --- |
Mixtur e  o f  V ectors
|     | ( M O V ) |     |     | 5 #    | inputs shape: | [batch,        | seq, h_dim] |     |
| --- | --------- | --- | --- | ------ | ------------- | -------------- | ----------- | --- |
...
| --- | ---- | --- | --- | --- | --- | --- | --- | --- |
7
|     | vec2 |     |     | 8 #           | MOV scaling | vectors:                  | [n_experts, | h_dim] |
| --- | ---- | --- | --- | ------------- | ----------- | ------------------------- | ----------- | ------ |
...
|     |        | Q   | K V | 15              |                  |                             |               |        |
| --- | ------ | --- | --- | --------------- | ---------------- | --------------------------- | ------------- | ------ |
|     | Router |     |     | 16 #            | combined vector: | [batch,                     | seq,          | h_dim] |
...
(IA)3
of new parameters inserted by is determined by the architecture as the scaling vectors need to
...
|     |     |     |     | Rdm×dp |     |     |     | Rdm, |
| --- | --- | --- | --- | ------ | --- | --- | --- | ---- |
in LLMs. For a pre-trained weight matrix W ∈ and input activation x ∈ LORA
0
| decomposes | W into | two low-rank | matrices: |     |     |     |     |     |
| ---------- | ------ | ------------ | --------- | --- | --- | --- | --- | --- |
0
|     |       |        | h = W +∆W | = W | +BAx |     |     | (LORA) |
| --- | ----- | ------ | --------- | --- | ---- | --- | --- | ------ |
|     |       |        | 0         | x 0 |      |     |     |        |
|     | Rdp×r | Rr×dm, |           |     |      |     |     |        |
where B ∈ A ∈ and the rank r = min(dm,dp). During fine-tuning, all pretrained
...
key K, value V, and output O of the self-attention and the feed-forward layers W and W . Unlike
|     |     |     |     |     |     |     | 1   | 2   |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ----------- | ------------- | ---- | ------------ | ----------- | ----- | --- | --- | --- |
| ∗For        |               |      |              |             | (IA)3 |     |     |     |
an encoder-decoder model with L number of layers in both sides, only introduces L(d k +d v +d ff ) new
parameters for encoder and L(2d k +2d v +d ff ) for decoder, due to the additional encoder-decoder attention block.
4
...
R and a set of n experts E ,...,E where each expert E is a parameterized function. Following
1 n i
Fedus et al. (2022), our router network commonly consists of a dense layer with trainable weights
W
g
∈ Rdm×n followed by a softmax function which takes an intermediate token representation x as
input and combines the output of each expert based on the gating scores s ,...,s :
1 n
s = R(x) = softmax(WTx) (Router)
i i g
n
(cid:88)
y = s ·E (x) (MoE)
...
where each expert E corresponds to an independent dense feed-forward network. This multiplies the
i
...
combined expert E similar to Muqeeth et al. (2023):
mix
n
(cid:88)
E = s ·E ; y = E (x) (Soft Merging)
mix i i mix
i=1
...
andthebaselineson8held-out(unseenduringtraining)datasets–ANLI(Nieetal.,2020),HellaSwag
...
InourmainMoVandMoLORAmethods, routerlayerstakeintermediateembeddingsofinputtokens
...
assessdiscreteroutingwithtop-kusingload balancing followingtoFedusetal.(2022)whichpromotes
...
MoVusing30expertsachievesa14.57%performanceimprovementcomparedtoitsdensecounterpart
7

Zero-shot Results at 3B Scale
Model %Params. ANLI CB RTE WSC WIC Copa WNG HS Average
T0-3B(Sanhetal.,2022) 100% 33.46 50.0 64.08 64.42 50.39 74.92 50.51 27.51 51.91
Full-FT
T0-3B(ourreplication) 100% 41.08 80.36 76.17 53.37 53.92 88.94 57.46 29.19 60.06
...
OurMethod MoV-60 1.22% 38.83 76.79 74.55 60.1 52.66 89.79 55.49 30.47 59.83
...
Parameter efficient MoEs vs full fine-tuning How does MoEcompare to updating all parameters
...
770M Model Size 3B Model Size
| ycaruccA naideM egarevA 62 |     |     | ycaruccA naideM egarevA 62 |     |
| -------------------------- | --- | --- | -------------------------- | --- |
Full Fine-Tuning
| 60  |     |     | 60  |     |
| --- | --- | --- | --- | --- |
...
| 54  |     |     | 54  |     |
| 52  |     |     | 52  |     |
50 (IA)3 MoV-60 LoRA MoLoRA-10 50 (IA)3 MoV-30 LoRA MoLoRA-15
...
(IA)3
parameters, there is a 12.34% performance gap between and full fine-tuning vs 5.56% for
...
| 60 experts | are used. |     |     |     |
| ---------- | --------- | --- | --- | --- |
Thistrendofperformanceimprovementbyscalingmoreexpertsisfurthercorroboratedinthecontext
...
Token vs Sentence Embeddings for Routing Effectiveness of Expert Count vs. Model Sizes Top-K Selection
| 68  |     |     |     |     | 61  |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
ycaruccA naideM egarevA token ycaruccA naideM egarevA 64 MoV-10
| 66                 |     |     |     |     | 60                 |     |                |
| ------------------ | --- | --- | --- | --- | ------------------ | --- | -------------- |
| sentence embedding |     | 62  |     |     |                    |     | MoV-10 (top-2) |
| 64                 |     |     |     |     | ycaruccA naideM 59 |     |                |
|                    |     | 60  |     |     |                    |     | MoV-10 (top-1) |
| 62                 |     |     |     |     | 58                 |     |                |
|                    |     |     |     | 11B | 57                 |     | MoV-2          |
| 60                 |     | 58  |     | 3B  |                    |     | MOV-1 = (IA)3  |
...
| --------------------- | --- | --- | ----------------- | --- | --- | ------------------ | --- |
| 52                    |     | 50  |                   |     | 52  |                    |     |
| 770M                  | 3B  | 11B | 1 10 30           | 60  |     | Routing Strategies |     |
| Base Model Components |     |     | Number of Experts |     |     |                    |     |
...
| --- | --------------- | --- | -------------- |
|     | quail           |     | super_glue_cb  |
| 0.5 | rotten_tomatoes | 0.5 | super_glue_wic |
ytilibaborP gnituoR .gvA
|     | common_gen |     | winogrande |
| --- | ---------- | --- | ---------- |
| 0.4 |            | 0.4 |            |
| 0.3 |            | 0.3 |            |
| 0.2 |            | 0.2 |            |
| 0.1 |            | 0.1 |            |
| 0.0 |            | 0.0 |            |
Expert 1 Expert 2 Expert 3 Expert 4 Expert 5 Expert 1 Expert 2 Expert 3 Expert 4 Expert 5
...
super_glue_cbactivateExpert3themostoutofthe5experts, followedbyExpert4butaredifferent
...
Fedusetal.,2022;Duetal.,2022;Zophetal.,2022;Clarketal.,2022;Zhouetal.,2022;Komatsuzaki
...
weightmatrices. UnliketheotherPEFTmethods, (IA)3 doesnotinduceanyadditionalinferencecost
...
mixture of adapters for BERT with 110M parameters (Devlin et al., 2019) and RoBERTa
base large
...
associatedwithscalinginstruction-tunedLLMsatscale. Ourmethodoutperformsparameter-efficient
...
KevinRobinson, DashaValter, SharanNarang, GauravMishra, AdamsYu, VincentZhao, Yanping
Huang, AndrewDai, HongkunYu, SlavPetrov, EdH.Chi, JeffDean, JacobDevlin, AdamRoberts,
...
NeilHoulsby, AndreiGiurgiu, StanislawJastrzebski, BrunaMorrone, QuentindeLaroussilhe, Andrea
...
HaokunLiu, DerekTam, MohammedMuqeeth, JayMohta, TenghaoHuang, MohitBansal, andColin
...
AlexanderSpiridonov,JoshuaNewlan,andAndreaGesmundo.Scalingupmodelsanddatawitht5x
...
Li, VincentZhao, HongkunYu, KurtKeutzer, TrevorDarrell, andDennyZhou. Mixture-of-experts
...
100% median 35.6 71.43 75.63 57.21 51.41 77.0 53.04 26.78 56.01
| Full-FT | T0-770M(ours) |      |                   |             |            |             |
| ------- | ------------- | ---- | ----------------- | ----------- | ---------- | ----------- |
|         |               | mean | 35.57 57.74 75.88 | 52.31 52.52 | 74.6 52.93 | 26.74 53.54 |
(IA)3 0.036% median 33.5 42.86 67.87 62.02 52.35 67.0 51.22 26.33 50.39
...
| --- | --- | ---- | ----------------- | ----------- | ---------- | ---------- |
MOV-5 0.27% median 33.6 41.07 71.48 61.54 50.86 76.5 51.46 26.02 51.57
...
| --- | ----- | --- | ---- | --- | --- | --- | --- | --- |
Model %Params. Metric ANLI CB RTE WSC WIC Copa WNG HS Average
| 100% | median | 33.46 | 50.0 64.08 | 64.42 50.39 | 74.92 | 50.51 | 27.51 | 51.91 |
| ---- | ------ | ----- | ---------- | ----------- | ----- | ----- | ----- | ----- |
T0-3B(Sanhetal.,2022)
|     | mean | 33.42 | 45.36 64.55 | 65.10 50.69 | 72.40 | 50.97 | 27.29 | 51.22 |
| --- | ---- | ----- | ----------- | ----------- | ----- | ----- | ----- | ----- |
Full-FT
| 100% | median | 41.08 | 80.36 76.17 | 53.37 53.92 | 88.94 | 57.46 | 29.19 | 60.06 |
| ---- | ------ | ----- | ----------- | ----------- | ----- | ----- | ----- | ----- |
T0-3B(ourreplication)
|     | mean | 40.73 | 74.52 76.82 | 52.21 53.84 | 88.99 | 56.83 | 29.2 | 59.14 |
| --- | ---- | ----- | ----------- | ----------- | ----- | ----- | ---- | ----- |
(IA)3 0.018% median 34.08 50.0 66.43 56.25 55.41 79.08 52.09 29.91 52.90
...
| --- | ------ | --- | ----- | --- | --- | --- | --- | --- |
Model %Params. Metric ANLI CB RTE WSC WIC Copa WNG HS Average
T0-11B(Sanhetal.,2022) 100% median 42.17 78.57 81.23 64.42 57.21 90.79 60.46 33.65 63.56
|     | mean | 41.16 | 70.12 80.83 | 61.45 56.58 | 90.02 | 59.94 | 33.58 | 61.70 |
| --- | ---- | ----- | ----------- | ----------- | ----- | ----- | ----- | ----- |
Full-FT T0-11B(ourreplication) 100% median 47.1 80.36 81.41 60.1 56.27 96.08 67.32 31.61 65.03
|     | mean | 45.83 | 72.62 81.52 | 58.17 56.66 | 96.0 | 66.77 | 30.95 | 63.57 |
| --- | ---- | ----- | ----------- | ----------- | ---- | ----- | ----- | ----- |
(IA)3 0.0098% median 42.3 73.21 75.99 58.65 52.04 86.27 54.3 30.27 59.12
PEFT
|     | mean | 42.1 | 63.27 75.31 | 55.49 52.27 | 85.74 | 55.06 | 30.09 | 57.41 |
| --- | ---- | ---- | ----------- | ----------- | ----- | ----- | ----- | ----- |
MoV-10 0.143% median 45.83 76.79 78.52 53.85 51.88 94.23 63.77 33.5 62.3
