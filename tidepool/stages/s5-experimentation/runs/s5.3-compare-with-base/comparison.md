...
Bootstrap resamples 10000, seed 20260826, 78 comparison(s) in the corrected family.

| arm | component | n | ref | arm | delta | 95% CI | macro | McNemar p | Holm p | reads as |
|---|---|--:|--:|--:|--:|---|--:|--:|--:|---|
| B1 | bfcl_native | 3490 | 0.7138 | 0.6822 | -0.0315 | [-0.0453, -0.0178] | -0.0120 | 9.341e-06 | 0.0006445 | separates |
| B1 | bfcl_text | 3490 | 0.6742 | 0.5504 | -0.1238 | [-0.1413, -0.1063] | -0.1790 | 4.191e-44 | 3.185e-42 | separates |
| B1 | ifstruct | 2000 | 0.1375 | 0.1355 | -0.0020 | [-0.0190, +0.0150] |  | 0.8621 | 1 | indistinguishable |
| B1 | ifeval | 541 | 0.7523 | 0.8189 | +0.0665 | [+0.0351, +0.0980] |  | 7.011e-05 | 0.004767 | separates |
| B1 | probes_detect | 270 | 0.9259 | 0.8074 | -0.1185 | [-0.1556, -0.0815] |  | 4.657e-10 | 3.399e-08 | separates |
| B1 | probes_clean | 30 | 0.9000 | 0.6333 | -0.2667 | [-0.4333, -0.1000] |  | 0.007813 | 0.4922 | separates before correction only |
| B1 | probes_stack_idiom | 144 | 0.1806 | 0.2361 | +0.0556 | [-0.0139, +0.1250] |  | 0.1849 | 1 | indistinguishable |
| B1 | probes_flag_detect | 270 | 0.6111 | 0.0074 | -0.6037 | [-0.6630, -0.5444] |  | 1.711e-49 | 1.334e-47 | separates |
| C2p | bfcl_native | 3490 | 0.7138 | 0.6785 | -0.0352 | [-0.0473, -0.0226] | +0.0001 | 2.399e-08 | 1.703e-06 | separates |
| C2p | bfcl_text | 3490 | 0.6742 | 0.6378 | -0.0364 | [-0.0456, -0.0272] | -0.0126 | 7.824e-15 | 5.868e-13 | separates |
| C2p | ifstruct | 2000 | 0.1375 | 0.1390 | +0.0015 | [-0.0125, +0.0155] |  | 0.89 | 1 | indistinguishable |
| C2p | ifeval | 541 | 0.7523 | 0.7283 | -0.0240 | [-0.0536, +0.0055] |  | 0.1299 | 1 | indistinguishable |
| C2p | probes_detect | 270 | 0.9259 | 0.7815 | -0.1444 | [-0.1852, -0.1037] |  | 3.638e-12 | 2.692e-10 | separates |
| C2p | probes_clean | 30 | 0.9000 | 0.8000 | -0.1000 | [-0.2333, +0.0000] |  | 0.25 | 1 | indistinguishable |
| C2p | probes_clean_corpus | 138 | 0.7319 | 0.7464 | +0.0145 | [-0.0290, +0.0580] |  | 0.7539 | 1 | indistinguishable |
| C2p | probes_stack_idiom | 144 | 0.1806 | 0.2500 | +0.0694 | [+0.0139, +0.1250] |  | 0.02127 | 1 | separates before correction only |
| C2p | probes_flag_detect | 270 | 0.6111 | 0.0074 | -0.6037 | [-0.6630, -0.5444] |  | 1.711e-49 | 1.334e-47 | separates |
| C2p | probes_flag_clean_corpus | 138 | 0.9855 | 1.0000 | +0.0145 | [+0.0000, +0.0362] |  | 0.5 | 1 | indistinguishable |
| C3 | bfcl_native | 3490 | 0.7138 | 0.7178 | +0.0040 | [-0.0063, +0.0143] | +0.0254 | 0.4756 | 1 | indistinguishable |
| C3 | bfcl_text | 3490 | 0.6742 | 0.6745 | +0.0003 | [-0.0089, +0.0095] | -0.0086 | 1 | 1 | indistinguishable |
| C3 | ifstruct | 2000 | 0.1375 | 0.1450 | +0.0075 | [-0.0065, +0.0215] |  | 0.3258 | 1 | indistinguishable |
| C3 | ifeval | 541 | 0.7523 | 0.7837 | +0.0314 | [+0.0037, +0.0592] |  | 0.04296 | 1 | separates before correction only |
...
| C3 | probes_flag_detect | 270 | 0.6111 | 0.6037 | -0.0074 | [-0.0704, +0.0556] |  | 0.9099 | 1 | indistinguishable |
| C3 | probes_flag_clean_corpus | 138 | 0.9855 | 0.9783 | -0.0072 | [-0.0362, +0.0217] |  | 1 | 1 | indistinguishable |
| C4 | bfcl_native | 3490 | 0.7138 | 0.6991 | -0.0146 | [-0.0229, -0.0063] | -0.0092 | 0.0006539 | 0.0425 | separates |
| C4 | bfcl_text | 3490 | 0.6742 | 0.6719 | -0.0023 | [-0.0080, +0.0037] | -0.0068 | 0.4968 | 1 | indistinguishable |
...
| C4 | probes_flag_detect | 270 | 0.6111 | 0.6519 | +0.0407 | [-0.0074, +0.0889] |  | 0.1173 | 1 | indistinguishable |
| C4 | probes_flag_clean_corpus | 138 | 0.9855 | 0.9710 | -0.0145 | [-0.0362, +0.0000] |  | 0.5 | 1 | indistinguishable |
| C5a | bfcl_native | 3490 | 0.7138 | 0.7086 | -0.0052 | [-0.0140, +0.0037] | -0.0114 | 0.2704 | 1 | indistinguishable |
| C5a | bfcl_text | 3490 | 0.6742 | 0.6636 | -0.0106 | [-0.0183, -0.0032] | -0.0183 | 0.007954 | 0.4931 | separates before correction only |
| C5a | ifstruct | 2000 | 0.1375 | 0.1515 | +0.0140 | [-0.0010, +0.0285] |  | 0.06973 | 1 | indistinguishable |
...
| C5b | bfcl_native | 3490 | 0.7138 | 0.7020 | -0.0117 | [-0.0212, -0.0020] | +0.0098 | 0.01766 | 1 | separates before correction only |
| C5b | bfcl_text | 3490 | 0.6742 | 0.6791 | +0.0049 | [-0.0037, +0.0135] | +0.0031 | 0.2882 | 1 | indistinguishable |
| C5b | ifstruct | 2000 | 0.1375 | 0.1095 | -0.0280 | [-0.0440, -0.0125] |  | 0.000561 | 0.03702 | separates |
| C5b | ifeval | 541 | 0.7523 | 0.7708 | +0.0185 | [-0.0129, +0.0518] |  | 0.3143 | 1 | indistinguishable |
| C5b | probes_detect | 270 | 0.9259 | 0.9407 | +0.0148 | [+0.0000, +0.0333] |  | 0.2188 | 1 | indistinguishable |
| C5b | probes_clean | 30 | 0.9000 | 0.8000 | -0.1000 | [-0.2333, +0.0000] |  | 0.25 | 1 | indistinguishable |
| C5b | probes_clean_corpus | 138 | 0.7319 | 0.7246 | -0.0072 | [-0.0435, +0.0290] |  | 1 | 1 | indistinguishable |
| C5b | probes_stack_idiom | 144 | 0.1806 | 0.2083 | +0.0278 | [-0.0347, +0.0972] |  | 0.5413 | 1 | indistinguishable |
| C5b | probes_flag_detect | 270 | 0.6111 | 0.6333 | +0.0222 | [-0.0259, +0.0704] |  | 0.4296 | 1 | indistinguishable |
| C5b | probes_flag_clean_corpus | 138 | 0.9855 | 1.0000 | +0.0145 | [+0.0000, +0.0362] |  | 0.5 | 1 | indistinguishable |
| C6 | bfcl_native | 3490 | 0.7138 | 0.7301 | +0.0163 | [+0.0040, +0.0289] | +0.0469 | 0.01193 | 0.7278 | separates before correction only |
| C6 | bfcl_text | 3490 | 0.6742 | 0.6817 | +0.0075 | [-0.0020, +0.0169] | -0.0019 | 0.1392 | 1 | indistinguishable |
| C6 | ifstruct | 2000 | 0.1375 | 0.1210 | -0.0165 | [-0.0315, -0.0010] |  | 0.04152 | 1 | separates before correction only |
| C6 | ifeval | 541 | 0.7523 | 0.7024 | -0.0499 | [-0.0813, -0.0185] |  | 0.002799 | 0.1791 | separates before correction only |
| C6 | probes_detect | 270 | 0.9259 | 0.9407 | +0.0148 | [+0.0000, +0.0333] |  | 0.2188 | 1 | indistinguishable |
...
| C6 | probes_stack_idiom | 144 | 0.1806 | 0.2153 | +0.0347 | [-0.0347, +0.0972] |  | 0.4049 | 1 | indistinguishable |
...
| C7 | bfcl_native | 3490 | 0.7138 | 0.6883 | -0.0255 | [-0.0358, -0.0152] | -0.0229 | 1.908e-06 | 0.0001336 | separates |
| C7 | bfcl_text | 3490 | 0.6742 | 0.6456 | -0.0287 | [-0.0384, -0.0192] | -0.0147 | 1.012e-08 | 7.289e-07 | separates |
| C7 | ifstruct | 2000 | 0.1375 | 0.1400 | +0.0025 | [-0.0120, +0.0170] |  | 0.7811 | 1 | indistinguishable |
...
| C7 | probes_clean_corpus | 138 | 0.7319 | 0.6957 | -0.0362 | [-0.0797, +0.0000] |  | 0.125 | 1 | indistinguishable |
| C7 | probes_stack_idiom | 144 | 0.1806 | 0.1944 | +0.0139 | [-0.0417, +0.0694] |  | 0.8036 | 1 | indistinguishable |
| C7 | probes_flag_detect | 270 | 0.6111 | 0.7222 | +0.1111 | [+0.0556, +0.1667] |  | 0.0001763 | 0.01181 | separates |
...
- B1/probes_clean_corpus selected no rows out of scored_probes.jsonl
- B1/probes_flag_clean_corpus selected no rows out of scored_probes.jsonl
...
- B1 against C1 on probes_clean_corpus skipped: one side is missing
- B1 against C1 on probes_flag_clean_corpus skipped: one side is missing

## Assertion failures

- B1 and C1 read probes_clean_corpus in the same item order: B1 reads da39a3ee5e6b, C1 reads 21b15226e1f6
- B1 and C1 read probes_flag_clean_corpus in the same item order: B1 reads da39a3ee5e6b, C1 reads 21b15226e1f6
