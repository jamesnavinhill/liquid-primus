...
|---|---|--:|--:|--:|--:|---|--:|--:|--:|---|
| C2p | bfcl_native | 3489 | 0.7140 | 0.6787 | -0.0353 | [-0.0476, -0.0229] | +0.0004 | 2.399e-08 | 1.584e-06 | separates |
| C2p | bfcl_text | 3489 | 0.6741 | 0.6377 | -0.0364 | [-0.0459, -0.0272] | -0.0126 | 7.824e-15 | 5.398e-13 | separates |
...
| C3 | bfcl_native | 3489 | 0.7140 | 0.7180 | +0.0040 | [-0.0063, +0.0140] | +0.0254 | 0.4756 | 1 | indistinguishable |
| C3 | bfcl_text | 3489 | 0.6741 | 0.6744 | +0.0003 | [-0.0092, +0.0095] | -0.0086 | 1 | 1 | indistinguishable |
...
| C4 | bfcl_native | 3489 | 0.7140 | 0.6993 | -0.0146 | [-0.0229, -0.0063] | -0.0092 | 0.0006539 | 0.04054 | separates |
| C4 | bfcl_text | 3489 | 0.6741 | 0.6718 | -0.0023 | [-0.0080, +0.0034] | -0.0068 | 0.4968 | 1 | indistinguishable |
...
| C5a | bfcl_native | 3489 | 0.7140 | 0.7088 | -0.0052 | [-0.0138, +0.0034] | -0.0117 | 0.2704 | 1 | indistinguishable |
| C5a | bfcl_text | 3489 | 0.6741 | 0.6635 | -0.0106 | [-0.0183, -0.0029] | -0.0183 | 0.007954 | 0.4772 | separates before correction only |
...
| C5b | bfcl_native | 3489 | 0.7140 | 0.7022 | -0.0118 | [-0.0212, -0.0023] | +0.0098 | 0.01766 | 1 | separates before correction only |
| C5b | bfcl_text | 3489 | 0.6741 | 0.6790 | +0.0049 | [-0.0034, +0.0135] | +0.0031 | 0.2882 | 1 | indistinguishable |
...
| C6 | bfcl_native | 3489 | 0.7140 | 0.7300 | +0.0160 | [+0.0032, +0.0287] | +0.0424 | 0.01345 | 0.7934 | separates before correction only |
| C6 | bfcl_text | 3489 | 0.6741 | 0.6816 | +0.0075 | [-0.0020, +0.0172] | -0.0019 | 0.1392 | 1 | indistinguishable |
...
| C7 | bfcl_native | 3489 | 0.7140 | 0.6884 | -0.0255 | [-0.0358, -0.0152] | -0.0232 | 1.908e-06 | 0.000124 | separates |
| C7 | bfcl_text | 3489 | 0.6741 | 0.6455 | -0.0287 | [-0.0381, -0.0189] | -0.0147 | 1.012e-08 | 6.783e-07 | separates |
...
- C1/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C1/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C2p/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C2p/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C3/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C3/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C4/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C4/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C5a/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C5a/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C5b/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C5b/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C6/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C6/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked
- C7/bfcl_native: score.json has no bfcl.styles.native_tools.item_weighted, so the rate is not cross-checked
- C7/bfcl_text: score.json has no bfcl.styles.tools_text.item_weighted, so the rate is not cross-checked

## Assertion failures

- C1/bfcl_native has no repeated item ids: 1 repeated id(s)
- C1/bfcl_text has no repeated item ids: 1 repeated id(s)
- C2p/bfcl_native has no repeated item ids: 1 repeated id(s)
- C2p/bfcl_text has no repeated item ids: 1 repeated id(s)
- C3/bfcl_native has no repeated item ids: 1 repeated id(s)
- C3/bfcl_text has no repeated item ids: 1 repeated id(s)
- C4/bfcl_native has no repeated item ids: 1 repeated id(s)
- C4/bfcl_text has no repeated item ids: 1 repeated id(s)
- C5a/bfcl_native has no repeated item ids: 1 repeated id(s)
- C5a/bfcl_text has no repeated item ids: 1 repeated id(s)
- C5b/bfcl_native has no repeated item ids: 1 repeated id(s)
- C5b/bfcl_text has no repeated item ids: 1 repeated id(s)
- C6/bfcl_native has no repeated item ids: 1 repeated id(s)
- C6/bfcl_text has no repeated item ids: 1 repeated id(s)
- C7/bfcl_native has no repeated item ids: 1 repeated id(s)
- C7/bfcl_text has no repeated item ids: 1 repeated id(s)
