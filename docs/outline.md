# this doc needs worked. discussed. jumped off from and eventually broken up and moved out to the appropriate document. avoid redundancy and overlap. it is for now the outoine and working conversation from google notebook
